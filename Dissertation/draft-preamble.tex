...
%автоматические ссылки на объекты
\crefname{equation}{уравнение}{уравнения}
\crefname{figure}{рисунке}{рисунки}
\crefname{table}{таблице}{таблицы}
\crefname{section}{разделе}{разделы}
\crefmultiformat{equation}{уравнения~(#2#1#3)}%
{ и~(#2#1#3)}{, (#2#1#3)}{ и~(#2#1#3)}
\crefmultiformat{table}{таблицах~#2#1#3}%
{ и~#2#1#3}{, #2#1#3}{ и~#2#1#3}
\crefmultiformat{figure}{рисунках~#2#1#3}%
{ и~#2#1#3}{, #2#1#3}{ и~#2#1#3}
\crefrangeformat{table}{таблицах~#3#1#4--#5#2#6}
\crefrangeformat{equation}{уравнения~(#3#1#4)--(#5#2#6)}
...
%%% Изображения %%%
\graphicspath{{../figures/}{figures/}}         % Пути к изображениям
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{../biblio/bibliopreamble}% Настройки библиографии из внешнего
